 ...
 */
public class AtomarDegreeFahrenheit extends AtomarUnit {

	/**
	 * Constructor for AtomarDegreeFahrenheit.
	 */
	public AtomarDegreeFahrenheit() {
		super(new DegreeFahrenheitSignature());
	}

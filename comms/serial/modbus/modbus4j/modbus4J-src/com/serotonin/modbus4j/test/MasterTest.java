...
//            batch.addLocator("hr1", new ModbusLocator(31, RegisterRange.HOLDING_REGISTER, 80, DataType.TWO_BYTE_BCD));
//            batch.addLocator("hr2", new ModbusLocator(31, RegisterRange.HOLDING_REGISTER, 81, DataType.FOUR_BYTE_BCD));
